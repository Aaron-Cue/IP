...
-- ejecucion de tests de todos los ejercicios juntos
...
-- ejecucion de tests de un ejercicio a la vez
...
--red sin usuarios y red sin relaciones ni publicaciones
redSinUsuarios = ([], [], [])
